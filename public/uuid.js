function UUIDProvider(Private) {

  var _ = require('lodash');
  var FieldFormat = Private(require('ui/index_patterns/_field_format/FieldFormat'));

  // Create a new FieldFormat type and inherit FieldFormat
  _.class(UUID).inherits(FieldFormat);

  function UUID(params) {
    console.log(params);
    UUID.Super.call(this, params);
  }
  ...
  function getLabel(value) {
    if (value in cache) {
      ...
      var label = value;
      jQuery.ajax({
        url: '//localhost:9000/label/' + encodeURIComponent(value),
...
require('ui/registry/field_formats').register(UUIDProvider);
